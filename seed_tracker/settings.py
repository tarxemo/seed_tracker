...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-seed-tracker-mbeya-2024-change-in-production')
...
ROOT_URLCONF = 'seed_tracker.urls'
...
WSGI_APPLICATION = 'seed_tracker.wsgi.application'
DATABASES = {
    'default': {
